...
2.1 Calculation of the optimal trajectory
...
2.2 Generating an option for students
...
3. The menu for checking the solution CHECK
3.1 The work performed by the student
...
3.3 Switching to simulation mode
...
4.3 Program turn (ProgramTurnMode.cs)
...
4.4 Program convergence (ProgramApproachMode.cs)
